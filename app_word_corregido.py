...
def generar_word():
    ...
    for table in doc.tables:
    ...
    elif any(cat in celdas[0].text.strip() for cat in notas_categoria):
        for cat in notas_categoria:
            if cat in celdas[0].text.strip():
                letra = notas_categoria[cat]
                break
        ...
        par.text = "X"
            ...
            elif "OBSERVACIONES GENERAL" in celdas[1].text:
                continue
            elif celdas[0].text.strip() == "" and celdas[1].text.strip() == "":
